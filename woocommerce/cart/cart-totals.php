...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
	...
	<div class="tp-cart-checkout-wrapper">
		...
		<div class="tp-cart-checkout-top d-flex align-items-center justify-content-between">
			<span class="tp-cart-checkout-top-title"><?php esc_html_e('Subtotal', 'woocommerce'); ?></span>
			<span class="tp-cart-checkout-top-price" data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>"><?php wc_cart_totals_subtotal_html(); ?></span>
		</div>
		...
		<?php elseif (WC()->cart->needs_shipping() && 'yes' === get_option('woocommerce_enable_shipping_calc')) : ?>
			...
			<div class="tp-cart-checkout-shipping">
				<h4 class="tp-cart-checkout-shipping-title"><?php esc_html_e('Shipping', 'woocommerce'); ?></h4>
